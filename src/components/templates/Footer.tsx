...
export const Footer = () => (
  <footer className="bg-main-700 dark:bg-gray-900 w-full border-t-4 border-red-300 min-h-[250px]">
    <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
      <div className="md:flex">
        <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-4 justify-between w-full">
          <div className="mb-6 md:mb-0 grid gap-4">
            <Logo/>
            <p className="font-thin">195 Broadway, 8th Floor</p>
            <p className="font-thin">New York, NY, 10007</p>
          </div>
          <div>
            <ul className="text-white font-medium grid gap-4">
              <li>
          ...
          <div>
            ...
            <p className="font-thin">hello@jump450.com</p>
